...
def get_post_statistics(reader_id: int, record_limit: int, result_limit: int) \
    ...
    records = PostReadingRecord.objects.filter(persona=reader_id).order_by('-read_count')[:record_limit]
