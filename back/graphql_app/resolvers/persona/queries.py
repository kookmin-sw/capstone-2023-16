...
from graphql_app.resolvers.persona.types import PersonaSortingOption, BirthYearFilter, NicknameFilter, GenderFilter, \
...
class Query:
    ...
    def get_own_personas(self, info: Info,
                         ...
                         birth_year_filter: Optional[BirthYearFilter] = None,
        ...
        filters = (OwnerFilter(requested_user), created_at_filter, birth_year_filter,
    ...
    def get_public_personas(self, info: Info,
        ...
        모든 공개 페르소나의 목록
        """
        filters = (IsPublicFilter(is_public=True), created_at_filter, birth_year_filter, nickname_filter,
