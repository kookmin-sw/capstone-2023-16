        ...
        <SafeAreaView>
            <View style={style.BackGroundView}>
                <View style={style.Header}>
                    ...
                    <BookmarkBtn onPress={()=>{}} img={String(require('../assets/bookmark_purple_fill.png'))} width={18} height={22}/>
                </View>
                <ScrollView style={style.BookPageStyle}>
                    ...
                    <View style={{...style.RowView, marginBottom: DimensionTheme.width(16), marginStart: DimensionTheme.width(24)}}>
                        <ReactBtn img={String(require('../assets/heart_purple_fill.png'))} onPress={()=>{}} width={28} height={33}/>
                        <ReactBtn img={String(require('../assets/bookmark_purple_fill.png'))} onPress={()=>{}} width={17} height={21}/>
                        <ReactBtn img={String(require('../assets/shared.png'))} onPress={()=>{}} width={26} height={26}/>
                    </View>
                    <View style={{...style.RowView, marginBottom: DimensionTheme.width(10)}}>
                        <Text style={style.Text}>좋아요 {props.like}개</Text>
                        <Text style={style.Text}>북마크 {props.bookmark}개</Text>
                        <Text style={style.Text}>댓글 {props.comment}개</Text>
                    </View>
                    <CommentInput/>
                </ScrollView>
            </View>
