...
const DetailScreen : FC<Props> = ({route, navigation}: Props) => {
    ...
    return (
        <SafeAreaView>
            <ImageBackground style={style.BackGroundView} source={require('../assets/background2.png')}>
                <View style={style.Header}>
                    ...
                    }} img={(likeCheck) ? String(require('../assets/heart_purple_fill.png')) : String(require('../assets/heart_purple_empty.png'))} width={25} height={29}/>
                    <BookmarkBtn onPress={()=>{
                        if (bookmarkCheck){
                    ...
                    }} img={(bookmarkCheck) ? String(require('../assets/bookmark_purple_fill.png')) : String(require('../assets/bookmark_purple_empty.png'))} width={18} height={22}/>
                </View>
                <View style={style.BookPageStyle}>
                    <View style={{width: '100%', height: DimensionTheme.height(22), backgroundColor: '(0,0,0,1)'}}/>
                    <ScrollView style={style.ScrollStyle} showsVerticalScrollIndicator={false}>
                        <DetailHeader feed_id={props.route.params.feed_id} title={props.route.params.title} author={props.route.params.author} author_img={props.route.params.author_img}/>
                        <Text style={style.Text}>
                            {props.route.params.content}
                        </Text>
                        <View style={{...style.RowView, marginBottom: DimensionTheme.width(16), marginStart: DimensionTheme.width(24)}}>
                            <ReactBtn
                                img={
                                    (likeCheck) ? String(require('../assets/heart_purple_fill.png')) : 
                            ...
                            <ReactBtn
                                img={
                                    (bookmarkCheck) ? String(require('../assets/bookmark_purple_fill.png')) :
                                ...
                                height={21}
                            />
                            <ReactBtn img={String(require('../assets/shared.png'))} onPress={()=>{}} width={26} height={26}/>
                        </View>
                        <View style={{...style.RowView, marginBottom: DimensionTheme.width(10), marginStart: DimensionTheme.width(24)}}>
                        ...
                        <View style={{marginStart: DimensionTheme.width(19), height:'auto'}}>
                            {
                                CommentExample.map((value, index) => {
                                    return (<Comment key={index} user_id={value.id} user_img={value.profile_img} comment={value.comment} date={value.date} nickname={value.nickname}/>);
                                })
                            }
                        </View>
